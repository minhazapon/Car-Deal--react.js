            ...
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    ...
                    <div class="space-y-4 max-lg:mt-4">
                        <button type="button" class="px-4 py-2 rounded-lg bg-[#00CCDD]  text-white text-sm tracking-wider font-medium outline-none border-2 border-[#00CCDD] mr-4 btn ">Premium</button>
                        <button type="button" class="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4 btn ">General</button>
                        <button type="button" class="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300  btn    ">Series</button>
                    </div>
                    ...
                    <form onSubmit={onSubmit} class="mt-8 space-y-4">
                        ...
                        {/* <button type='button'
                            class="text-white btn bg-[#00CCDD] hover:bg-[#a91079e2] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
                        ...
                        {/* <input className="text-white btn bg-[#00CCDD] hover:bg-[#a91079e2] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6" type="submit" value="Send" /> */}
